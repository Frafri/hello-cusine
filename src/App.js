    ...
    <div className="App">
      ...
      <header className="App-header">
        <nav className="App-table">
            <div> <a href="https://dolcementebaking.wixsite.com/dolcemente"> Home</a> </div>
            <div> <a href="https://dolcementebaking.wixsite.com/dolcemente/food-from-around-the-world"> Recipes</a> </div>
